"""
09_phase3_agentic_loop.py  —  Phase 3: Rolled Agentic Loop (early build)
...
BEFORE any OLS for that round. built_by: early_build
"""
...
# Paths & identity
# ---------------------------------------------------------------------------
SCRIPT_VERSION = "09_phase3_agentic_loop.py v1.0 (early_build / 2026-07-12)"
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Phase 3 rolled agentic loop (early build)")
