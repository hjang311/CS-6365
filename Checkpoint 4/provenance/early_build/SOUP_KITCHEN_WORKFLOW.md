...
**Build:** Checkpoint 4 / `early_build/` (early build)  
...
```bash
.venv/bin/python "Checkpoint 4/early_build/10_acquire_soup_kitchens.py" --feasibility
.venv/bin/python "Checkpoint 4/early_build/10_acquire_soup_kitchens.py" --pilot
...
```bash
.venv/bin/python "Checkpoint 4/early_build/10_acquire_soup_kitchens.py" --build-agent-collection --merge-agent-collection
.venv/bin/python "Checkpoint 4/early_build/11_merge_soup_kitchen_density.py"
