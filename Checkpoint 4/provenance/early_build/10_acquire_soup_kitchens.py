"""
10_acquire_soup_kitchens.py  —  ACFB partner / soup-kitchen acquisition (early build)
...
def print_feasibility() -> None:
    print("=== ACFB food-map feasibility (early build) ===")
    ...
    for attempt in range(retries):
        try:
            req = urllib.request.Request(
                url,
                headers={"User-Agent": "NORP-CS6365-research/1.0"},
            )
