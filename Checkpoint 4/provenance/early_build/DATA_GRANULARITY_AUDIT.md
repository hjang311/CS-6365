# Data Time & Space Granularity Audit (early build)

**Date:** 2026-07-12  
**Scope:** Checkpoint 3 modeling frame + Checkpoint 4 / `early_build/` food-assistance stretch  
...
| Reproducibility / provenance | **OK** (`built_by: early_build`, decision log, CC BY attribution) |
