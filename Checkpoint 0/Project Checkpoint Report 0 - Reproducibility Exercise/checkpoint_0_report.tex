...
The target project is \textbf{Prior Cohort NORP Package}. The environment was set up on macOS with Python 3.9.6. A virtual environment was created, and all dependencies from \texttt{requirements.txt} were installed.
