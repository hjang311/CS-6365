...
- **Canonical Phase 3:** `Checkpoint 4/09_phase3_agentic_loop.py`, `engine/`, `configs/`, `prompts/`, `docs/`
- **Canonical skills:** `.agent/skills/norp-*` (role contracts for hybrid IDE orchestration or SDK)
- **Provenance only:** `Checkpoint 4/provenance/early_build/` (earlier build trail; not the student entrypoint)
...
- **Studio map:** `Checkpoint 4/docs/STRUCTURE.md`
